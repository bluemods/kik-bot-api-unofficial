...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'abtesting.v1.ab_testing_shared_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EXPERIMENT'].fields_by_name['name']._serialized_options = b'\312\235%\007\010\001(\0010\377\001'
  _globals['_EXPERIMENT'].fields_by_name['variant']._loaded_options = None
  _globals['_EXPERIMENT'].fields_by_name['variant']._serialized_options = b'\312\235%\007\010\001(\0010\377\001'
  _globals['_EXPERIMENT'].fields_by_name['experiment_id']._loaded_options = None
  _globals['_EXPERIMENT'].fields_by_name['experiment_id']._serialized_options = b'\312\235%\007\010\000(\0000\377\001'
  _globals['_EXPERIMENT']._serialized_start=88
  _globals['_EXPERIMENT']._serialized_end=193
