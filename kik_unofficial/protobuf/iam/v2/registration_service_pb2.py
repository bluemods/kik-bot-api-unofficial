...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'iam.v2.registration_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_VALIDATEFORREGISTERREQUEST'].fields_by_name['email']._loaded_options = None
  _globals['_VALIDATEFORREGISTERREQUEST'].fields_by_name['email']._serialized_options = b'\312\235%\002\010\000'
  _globals['_VALIDATEFORREGISTERREQUEST'].fields_by_name['username']._loaded_options = None
  _globals['_VALIDATEFORREGISTERREQUEST'].fields_by_name['username']._serialized_options = b'\312\235%\002\010\000'
  _globals['_REGISTERREQUEST'].fields_by_name['first_name']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['first_name']._serialized_options = b'\312\235%\005\010\001 \377\001'
  _globals['_REGISTERREQUEST'].fields_by_name['last_name']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['last_name']._serialized_options = b'\312\235%\005\010\001 \377\001'
  _globals['_REGISTERREQUEST'].fields_by_name['username']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['username']._serialized_options = b'\312\235%\002\010\001'
  _globals['_REGISTERREQUEST'].fields_by_name['email']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['email']._serialized_options = b'\312\235%\002\010\001'
  _globals['_REGISTERREQUEST'].fields_by_name['device_details']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['device_details']._serialized_options = b'\312\235%\002\010\001'
  ...
  _globals['_REGISTERREQUEST'].fields_by_name['birthday']._serialized_options = b'\312\235%\002\010\001'
  _globals['_REGISTERREQUEST'].fields_by_name['username_passkey']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['username_passkey']._serialized_options = b'\312\235%\005\010\0010\200\010'
  _globals['_REGISTERREQUEST'].fields_by_name['email_passkey']._loaded_options = None
  _globals['_REGISTERREQUEST'].fields_by_name['email_passkey']._serialized_options = b'\312\235%\005\010\0010\200\010'
  _globals['_VALIDATEFORREGISTERREQUEST']._serialized_start=208
  _globals['_VALIDATEFORREGISTERREQUEST']._serialized_end=324
  _globals['_VALIDATEFORREGISTERRESPONSE']._serialized_start=327
  _globals['_VALIDATEFORREGISTERRESPONSE']._serialized_end=600
  _globals['_VALIDATEFORREGISTERRESPONSE_RESULT']._serialized_start=510
  _globals['_VALIDATEFORREGISTERRESPONSE_RESULT']._serialized_end=557
  _globals['_VALIDATEFORREGISTERRESPONSE_INVALIDELEMENT']._serialized_start=559
  _globals['_VALIDATEFORREGISTERRESPONSE_INVALIDELEMENT']._serialized_end=600
  _globals['_REGISTERREQUEST']._serialized_start=603
  _globals['_REGISTERREQUEST']._serialized_end=1073
  _globals['_REGISTERRESPONSE']._serialized_start=1076
  _globals['_REGISTERRESPONSE']._serialized_end=1665
  _globals['_REGISTERRESPONSE_RESULT']._serialized_start=1310
  _globals['_REGISTERRESPONSE_RESULT']._serialized_end=1469
  _globals['_REGISTERRESPONSE_REQUESTELEMENT']._serialized_start=1472
  _globals['_REGISTERRESPONSE_REQUESTELEMENT']._serialized_end=1665
  _globals['_REGISTRATION']._serialized_start=1668
  _globals['_REGISTRATION']._serialized_end=1873
